...
echo -n "Your data have been prepared for export. Click \"Download file\" below to get your data as a single compressed file. If the download button doesn't appear, contact support immediately. Debug data follows. \n\n " $foo > $4
